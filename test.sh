...
assert 50 "main() { a = 23; b = 3 + 5 * 2; c = b + (a + b > a); return a + b + c; }"
assert 23 "main() { a = 23; return 23; b = 3 + 5 * 2; c = b + (a + b > a); return a + b + c; }"
assert 3 "main() { a = 0; if (1) a = 3; return a; }"
assert 0 "main() { a = 0; if (0) a = 3; return a; }"
...
assert 3 "main() { a = 0; if (1) { a = 1; a = a + 2; } return a; }"
assert 10 "main() { i = 0; sum = 0; while (i < 4) { i = i + 1; sum = sum + i; } return sum; }"
assert 6 "main() { sum = 0; for (i = 0; i < 4; i = i + 1) { sum = sum + i; } return sum; }"
assert 2 "main() { if (1) { if (0) { return 1; } else { return 2; } } return 3; }"
assert 0 "main() { value = 42; }"
...
assert_error "main() { for (i = 0; i < 1; i = i + 1) {} return i; }"
